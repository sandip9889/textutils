    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item">
            <a className="nav-link" href="./component/About.js">{props.Aboutext}</a>
          </li>
...
//probtypes which type you have to send to app.js
//props is container type wher we can derive some parts of data from whole like title.name etc
